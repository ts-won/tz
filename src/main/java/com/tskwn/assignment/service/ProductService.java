...
public class ProductService {
    ...
    public List<ProductDto> getCategoryLowestPrice() {
        return Arrays.stream(Category.values())
                ...
                .map(Optional::get).map(ProductDto::from).collect(Collectors.toList());
    }
    ...
    public ProductDto create(ProductDto productDto) {
        ...
        return ProductDto.from(productRepository.save(productDto.toEntity(brand)));
    }
    ...
    public ProductDto update(Long productId, ProductDto productDto) {
        ...
        product.setCategory(Category.valueOf(productDto.getCategoryName()));
