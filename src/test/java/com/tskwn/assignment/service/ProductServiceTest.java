...
public class ProductServiceTest {
    ...
    void test_getCategoryLowestPrice() {
        ...
        when(product1.getCategory()).thenReturn(Category.TOP);
        when(product2.getCategory()).thenReturn(Category.HAT);
        when(product3.getCategory()).thenReturn(Category.BAG);
        when(product4.getCategory()).thenReturn(Category.OUTER);
        when(product5.getCategory()).thenReturn(Category.ACCESSORY);
        when(product1.getBrand()).thenReturn(brand);
        when(product2.getBrand()).thenReturn(brand);
        when(product3.getBrand()).thenReturn(brand);
        when(product4.getBrand()).thenReturn(brand);
        when(product5.getBrand()).thenReturn(brand);
    ...
    void test_create() {
        ...
        when(product.getCategory()).thenReturn(Category.HAT);
    ...
    void test_update() {
        ...
        // when
        when(productDto.getCategoryName()).thenReturn(Category.HAT.name());
